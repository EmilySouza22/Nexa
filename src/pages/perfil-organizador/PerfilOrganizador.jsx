...
function PerfilOrganizador() {
  ...
  const isMinhaContaAtiva = location.pathname === "/minha-conta";
    ...
    <div className="organizador-container">
      ...
      <div className="abas-container">
        ...
        <NavLink 
          to="/organizador"
          className={({ isActive }) => 
            isActive ? "aba ativa" : isMinhaContaAtiva ? "aba aba-com-risco" : "aba"
          }
        >
          Organizador
        </NavLink>
        ...
        <div className="foto-area">
          ...
          <div className="info-imagem-container">
            ...
            <div className="aviso-imagens">
              Você pode enviar imagens nos formatos JPG, JPEG ou PNG, com tamanho máximo de 10MB. 
              Evite conteúdo impróprio, como nudez ou imagens ofensivas — isso pode resultar na remoção do seu perfil.
            </div>
            ...
            <div className="imagem-botoes">
              ...
              <button type="button" onClick={excluirImagem} className="btn-excluir">
                Excluir imagem
              </button>
